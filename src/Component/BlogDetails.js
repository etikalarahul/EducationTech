    ...
    const data = [
        {
            ...
            ReactJS is a popular JavaScript library for building user interfaces. It's widely used by developers and companies worldwide, including Facebook, Netflix, and Airbnb. If you're new to ReactJS, it can be intimidating to get started. In this blog post, we'll provide a beginner's guide to ReactJS and help you understand the basics of this powerful library.
            
            What is ReactJS?
            ReactJS is a JavaScript library that's used to build user interfaces. It's based on the concept of components, which are reusable pieces of code that can be used to create complex UIs. ReactJS was developed by Facebook and was released to the public in 2013. Since then, it has become one of the most popular libraries for building UIs.
...
JavaScript Basics:
Here are some basic concepts to understand when working with JavaScript:
...
JavaScript is a powerful programming language that's used to create dynamic web content. Its versatility and widespread use make it a valuable skill for web developers to have. By understanding the basics of JavaScript, you can begin creating dynamic web content and exploring the many possibilities that this language has to offer.
    ...
    return (
        <div>
            ...
            <p>{data[id.blogId].description}</p>
